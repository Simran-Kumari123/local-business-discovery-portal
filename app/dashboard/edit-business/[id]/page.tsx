...
import { Building2, Upload, X, Loader2, ArrowLeft, Save } from 'lucide-react'
...
export default function EditBusinessPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <div className="min-h-screen bg-secondary/30">
            {/* Header */}
            <section className="relative py-14 overflow-hidden bg-linear-to-br from-emerald-700 via-emerald-600 to-teal-500">
                <div
                ...
                <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
                    ...
                    <p className="text-emerald-100 text-lg max-w-2xl mx-auto">
                        Update your business information, images, and location details.
                    </p>
                </div>
                ...
                <div className="bg-card border border-border rounded-2xl shadow-sm p-8 md:p-10">
                    <form onSubmit={handleSubmit} className="space-y-8">
                            ...
                            <label className="flex flex-col items-center justify-center w-full h-36 border-2 border-dashed border-border rounded-2xl cursor-pointer hover:border-primary/50 hover:bg-primary/5 transition-all duration-200">
                                ...
                                {uploading ? (
                                    ...
                                    <>
                                        ...
                                        <span className="text-sm text-muted-foreground font-medium">Click to upload more images</span>
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full flex items-center justify-center gap-2 py-4 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-lg rounded-xl shadow-md transition-all duration-200 hover:scale-[1.01] disabled:opacity-60 disabled:cursor-not-allowed"
                        >
                            {loading ? (
